...
public class Calculator {
    ...
    private JComboBox<String> comboCalcuType, comboTheme;
    ...
    public Calculator(){
        ...
        comboTheme = initCombo(new String[]{"Simple", "Colored", "DarkThem",}, 230, 30, "Theme", themeSwitchEventConsumer);
        comboCalcuType = initCombo(new String[]{"Standard", "Scientific"}, 20, 30, "Calculator Type", calcuTypeSwitchEventConsumer);
        ...
        inText.setFont(new Font("Comics Sans MS", Font.PLAIN, 33));
        window.add(inText);
    ...
    private Consumer<ItemEvent> calcuTypeSwitchEventConsumer  = event ->{
    ...
    private Consumer<ItemEvent> themeSwitchEventConsumer = event->{
       ...
       String selectTheme = (String) event.getItem();
       switch (selectTheme){
           case "Simple":
